...
void Application::render() {
	...
	for (auto*&i : this->ComputationalDomains) {
		i->changeColorParticlesTo(app_coloringPart);
		ImGui::Text("Coloring particles: %s", (i->ColoringParticles).c_str());
	}


	ImGui::InputText(" - Coloring parameter", app_coloringParam, 30);
	for (auto*&i : this->ComputationalDomains) {
